...
public:
    ...
    void imageRGBCallback(const sensor_msgs::CompressedImage::ConstPtr &rgb_msg)
    {
        ...
        // image pose
        string image_frame = "body";
        geometry_msgs::Pose pose_ = poseCallback(image_frame);
    ...
    void imageDepthCallback(const sensor_msgs::Image::ConstPtr &depth_msg)
    {
        ...
        // Image time and pose
        string image_frame = "body";
        geometry_msgs::Pose pose_ = poseCallback(image_frame); // Assuming that poseCallback is defined somewhere
